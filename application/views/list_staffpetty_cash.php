        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><b>Listing All</b> Petty Cash</h3>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                      ...
                      foreach ($arr as $petty): 
                      $n++;
                ?>
                <tr>
                  <td><?= $n?></td>
                  <td><?= $petty->petty_date; ?></td>
                  <td><?= $petty->request_amount; ?></td>
                  <td><?= $petty->bal_amount; ?></td>
                  <td><?= $petty->descrip; ?></td>
                  <td id="exclude_column"><a href="<?= site_url('dashboard/page/a21?view=').$petty->petty_id; ?>" name="c5" title="View Petty Cash">
                  <button type="button" class="btn btn-info btn-xs" title="View"><i class="fa fa-eye"></i></button></a>
                  &nbsp;&nbsp;&nbsp;
                  <a href="<?= site_url('dashboard/page/c24?edit=').$petty->petty_id; ?>" name="c5" title="Edit Petty Cash">
                  <button type="button" class="btn btn-warning btn-xs"><i class="fa fa-pencil"></i></button>
                  &nbsp;&nbsp;&nbsp;
                  <a onclick = "return onDel();" href="<?= site_url('dashboard/page/c25?delete=').$petty->petty_id; ?>" name="c5" title="Delete User">
                  <button type="button" class="btn btn-danger btn-xs"><i class="fa fa-close"></i></button></a>
                  &nbsp;&nbsp;&nbsp;
                  <a onclick = "return onDel();" href="<?= site_url('dashboard/page/c42?print=').$petty->petty_id; ?>" name="c5" title="Print">
