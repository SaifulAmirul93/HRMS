                      ...
                      foreach ($arr as $data) { ?>
                       ...
                       <input type="hidden" class="form-control <?= $n.'ros' ?>" value="<?= $data->holiday_id ?>">
                        <!--   title: '',
                          ...
                          backgroundColor: "",
                          borderColor: "<?= $data->holiday_color; ?>" -->
                          <?php
                      }
                  }  
                  ?>
        <!--         <div style="background-color:#E10D0D ">Lunch</div>
                <div class="event bg-yellow">Go home</div>
                <div class="event bg-aqua">Do homework</div>
                <div class="event bg-light-blue">Work on UI design</div>
                <div class="event bg-red">Sleep tight</div> -->
                <!-- <div class="checkbox">
       ...
       <?php 
        ...
        if (sizeof($arr) != 0) {
            ...
            foreach ($arr as $data) {
                ...
                echo "{";
                ?>
                title: '<?= $data->emp_holidayDescription; ?>',
                start: "<?= $data->emp_holidayDate; ?>",
                end: "<?= $data->emp_holidayEndDate; ?>",
                backgroundColor: "<?= $data->holiday_color; ?>",
                borderColor: "<?= $data->holiday_color; ?>"
                <?php
            }
        }else{
