...
<head>
  ...
  <title>Nasty H.R.M.S| Registration Page</title>
...
<div class="register-box">
  ...
  <div class="register-box-body">
    ...
    <form action="<?= site_url('login/signup'); ?>" method="post">
    ...
    <a href="<?= site_url('login/signin'); ?>" class="text-center">I already have a membership</a>
  </div>
  <!-- /.form-box -->
</div>
<!-- /.register-box -->
...
<!-- iCheck -->
<script src="<?php echo base_url();?>/lugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
