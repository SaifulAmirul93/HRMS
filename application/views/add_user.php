              ...
              <div class="row">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                      ...
                      <form role="form" method="post" action="<?= site_url('dashboard/addUser'); ?>">
                               ...
                               <div class="col-md-4">
                                    <div class="form-group">
                                      <label for="ic_No">User Email:</label>
                                       ...
                                       <input class="form-control input-sm" type="text" name="user_email" id="user_email">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <select class="form-control" name=" user_role" id=" user_role">
                                        <?php foreach ($lvl as $key) {
                                          ?>
                                              <option value="<?= $key->role_id; ?>"><?= $key->role_desc; ?></option>
