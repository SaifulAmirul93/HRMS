        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><b>Listing All</b> Attendance</h3>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                      ...
                      foreach ($arr as $attndnce){
                      $n++;
                ?>
                <tr>
                  <td><?= $n?></td>
                  <td><?= $attndnce->emp_id; ?></td>
                  <td><?= $attndnce->emp_fullname; ?></td>
                  <td><?= $attndnce->time_in; ?></td>
                  <td><?= $attndnce->time_out; ?></td>
                  <!-- <td><?= $emp->employeeType; ?></td>
                  <td><?= $emp->emp_accBank; ?></td>
                  <td><?= $emp->emp_designation; ?></td> -->
                  <!-- <td><a href="" name="c5" title="View Employee">
