      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-primary">
            ...
            <div class="container">
          <h4><b><i class="fa fa-clock-o"></i> OVERTIME DETAILS</b></h4>          
          <table class="table table-bordered">
    
          <tbody>
            <tr>
              <td><b>Claimer Name</b></td>
              <td><?= $arr->emp_name;?></td>
            </tr>
            <tr>
              <td><b>Date</b></td>
              <td><?= $arr->emp_OTDate;?></td>
            </tr>
            <tr>
              <td><b>Day</b></td>
              <td><?= $arr->emp_OTDay;?></td>
            ...
            <tr>
              <td colspan="2"><b>Time Worked</b></td>
            </tr>
            <tr>
              <td><b>In</b></td>
              <td><?= $arr->emp_OTIn;?></td>
            ...
            <tr>
              ...
              <td><?= $arr->emp_OTTotal_hour;?></td>
            </tr>
            <tr>
              <td><b>Remarks</b></td>
              <td><?= $arr->emp_OTRemarks;?></td>
            </tr>
            <tr>
