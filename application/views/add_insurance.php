  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Apply Insurance</li>
      </ol>
    </section>
          ...
          <!-- /.box -->
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title"><b>Apply Insurance</b></h3>
                    ...
                    <div id="empInfo">
                           ...
                           <div class="row">
                               ...
                               <div class="row">
                                   ...
                                   <div class="col-md-4">
                                    <div class="form-group">
                                      <label for="ic_No">Type of Insurance : </label>
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      <label for="ic_No">Amount of Insurance : RM</label>
                                      
                                     <input class="form-control input-sm" type="text" name="adv_date" id="adv_date" value="">
