            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                      ...
                      foreach ($arr as $leave): 
                      $n++;
                ?>
                <tr>
                  <td><?= $n?></td>
                  <td><?= $leave->emp_fullname; ?></td>
                  <td><?= $leave->emp_id; ?></td>
                  <td><?= $leave->leaveType; ?></td>
                  <td><?= $leave->leaveRequestDate; ?></td>
                  <td><?= $leave->leaveStartDate; ?></td>
                  <td><?= $leave->leaveEndDate; ?></td>
                  <td><?= $leave->leave_description; ?></td>
                  <td id="exclude_column"><a href="<?= site_url('dashboard/page/h6?view=').$leave->leave_id; ?>" name="c5" title="View Intern">
                  <button type="button" class="btn btn-info btn-xs" title="View"><i class="fa fa-eye"></i></button></a>
                  &nbsp;&nbsp;&nbsp;
                  <a href="<?= site_url('dashboard/page/c31?edit=').$leave->leave_id; ?>" name="c5" title="Edit Leave">
                  <button type="button" class="btn btn-warning btn-xs"><i class="fa fa-pencil"></i></button>
                  &nbsp;&nbsp;&nbsp;
                  <a onclick = "return onDel();" href="<?= site_url('dashboard/page/c30?delete=').$leave->leave_id; ?>" name="c5" title="Delete Leave">
                  <button type="button" class="btn btn-danger btn-xs"><i class="fa fa-close"></i></button></a>
                  &nbsp;&nbsp;&nbsp;
                  <a href="<?= site_url('dashboard/page/c36?print=').$leave->leave_id; ?>" name="c5" title="Print Intern">
