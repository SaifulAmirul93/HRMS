    ...
    <div class="col-lg-10" style="box-shadow:10px 10px 5px #ccc;background-color:#FFFFFF;">
        ...
        <div class="row">
          ...
          <div class="box box-primary">
            ...
            <div align="center">
              ...
              <div class="container">
          <h4><b><i class="fa fa-money"></i> PETTY CASH INFORMATION</b></h4>          
      ...
      <!-- keluarkan output dekat print -->
          <tbody>
            ...
            <tr>
              <td><b>Date</b></td>
              <td><?= $arr->petty_date;?></td>
            </tr>
            <tr>
              <td><b>Date</b></td>
              <td><?= $arr->date_request;?></td>
            </tr>
            <tr>
              <td><b>Amount</b></td>
              <td><?= $arr->request_amount;?></td>
            </tr>
            <tr>
              <td><b>Date</b></td>
              <td><?= $arr->bal_date;?></td>
            ...
            <tr>
              <td><b>Amount </b></td>
              <td><?= $arr->bal_amount;?></td>
            </tr>
            <tr>
              <td><b>Description of need</b></td>
              <td><?= $arr->descrip;?></td>
            </tr>
          </tbody> 
          </table>
